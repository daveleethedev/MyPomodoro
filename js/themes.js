...
function yellowTheme(){
    ...
    config.style.backgroundColor = '#59680391';
    config.style.color = "#ffffffff"
...
function redTheme(){
    ...
    config.style.backgroundColor = '#6e1212e6';
    config.style.color = "#ffffffff"
...
function pinkTheme(){
    ...
    config.style.backgroundColor = '#791755e6';
    config.style.color = "#ffffffff"
...
function whiteTheme(){
    ...
    config.style.backgroundColor = '#ffffffa4';
    config.style.color = "#020202ff"
